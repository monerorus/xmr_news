...
> _**ArticMine:**_ Да, действительно, это всё равно что сказать: «счет за электричество составляет порядка 30% моих месячных затрат, но майнинг помогает мне окупать всего 0,5%  
...
> _**moneromooo:**_ В ASIC действительно нет ничего плохого, если они не владеют большей частью хешрейта сети  
...
> _**learninandlurkin:**_ Эвристика может превратиться в незамысловатую игру. Если бы разработчики ASIC знали, что мы переключимся на их предпочтительный алгоритм в момент обновления сети, в их интересах было бы утаить свои замыслы и сделать всё тихо и без свидетелей  
...
> _**dEBRUYNE:**_ fluffypony: Вот эта -> _**sech1:**_ Резкое увеличение хэшрейта (и снижение прибыльности) без изменения цены является прямым показателем появления более эффективного аппаратного обеспечения (ASIC)  
...
> _**hyc:**_ oneiric_: FPGA будет на одном уровне с GPU. Не лучше и не хуже. Не имеет смысла зацикливаться на FPGA  
...
> _**learninandlurkin:**_ Но, может быть, для людей, которые давно не заглядывали в #monero-pow, стоит пояснить, что происходит в последнее время? Я видел, что были некоторые интересные результаты тестов от многих заинтересованных людей  
...
> _**learninandlurkin:**_ Я думаю, что нам потребуются эксперты по оборудованию, а также традиционные аудиторы кода  
...
> _**learninandlurkin:**_ Конечно, это зависит от характера сбоя  
...
> _**learninandlurkin:**_ шесть цифр? может ли CCS принять это условие на медвежьем рынке? Это может занять намного больше времени, LOL  
...
> _**learninandlurkin:**_ с аппаратными / ASIC / PoW «экспертами», необходимыми для обзора спецификации?  
> _**midipoet:**_ обзор со стороны дизайнера ASIC, не?  
> _**dEBRUYNE:**_ tevador: Боюсь, оброз спецификации все же будет несколько субъективным  
...
> _**learninandlurkin:**_ Так что я думаю, мы могли бы остановиться на обзоре от Тим Олсона и Кристи-Ли  
...
> _**learninandlurkin:**_ на что были похожи эти случайные реакции? есть ценные и конструктивные предложения? отрицательные реакции?  
...
> _**rbrunner:**_ :)  
> _**learninandlurkin:**_ Просто «мы можем сделать 10x, я клянусь!», верно?  
> _**hyc:**_ верно  
...
> _**ArticMine:**_ или они просто чесно отказываются комментировать  
> _**ArticMine:**_ честно  
...
> _**learninandlurkin:**_ ссылка? Я сомневаюсь, что пойму хоть что-то, но это может быть ценным для записи журнала  
> _**learninandlurkin:**_ я имею ввиду обсуждение алгоритма на форуме  
...
> _**learninandlurkin:**_ мы просто подождем неизбежного краха ETH, у нас будет возможность перейти на ProgPow, не будучи миноритарным звеном! LOL  
> _**tevador:**_ Я не принимаю их слова близко к сердцу  
> _**learninandlurkin:**_ спасибо, я добавлю это в закладки  
...
> _**learninandlurkin:**_ Обращаясь к вопросу, затронутому dEBRUYNE, если получение правильных обзоров / аудитов останавливается, и сеть редактируется до октября, может ли CN-R быть настроен в качестве временного алгоритма?  
...
> _**dEBRUYNE:**_ rbrunner: Мы должны быть проактивными, а не реактивными  
...
> _**learninandlurkin:**_ второй вариант кажется противоречием, потому что как вы можете переключаться только в случае неудачи  
> _**ferretinjapan:**_ Проактивность не может предсказать будущее, в этом проблема  
> _**tevador:**_ было бы лучше сказать, что у нас не будет больше надстроек, и мы сможем лицезреть, что нам смогут «предложить» производители ASIC...  
...
> _**dEBRUYNE:**_ Быть проактивным также будет означать больший риск раскола сообщества  
...
> _**learninandlurkin:**_ Конечно, возможно, эти риски централизации будут смягчены воспроизводимыми сборками? Может быть, это должно быть поднято в списке текущих приоритетов  
...
> _**learninandlurkin:**_ fluffypony: не могли бы вы объяснить, почему нет? Это уменьшает фундаментальную зависимость от «ведущих» разработчиков и, следовательно, снижает риски, о которых вы упоминали ранее  
...
> _**needmoney90:**_ Да, если RandomX сработает, я целиком "за", но я реалист в том, что это, по большому счету, наша последняя попытка  
...
> _**tevador:**_ даже если бы был показатель в 2x ASIC, это не потребует такой же реакции как при 50x  
...
> _**tevador:**_ Я бы не считал превосходство в эффективности ASIC в 2 раза провалом для нас  
> _**moneromooo:**_ Если он провалится из-за того, что мы внезапно обнаружим что одна из сторон достигла почти 50% скорости сети.  
...
> _**ArticMine:**_ 2x в сторону ASIC не является провалом RandomX. Согласитесь ли вы на 50% скидку, выплачиваемую вам в XMR на ваши расходы за отопление, запустив на нашем компьютере немного программного обеспечения? 30% 10% 5% 1% 0.1% В этом весь вопрос.  
...
> _**learninandlurkin:**_ Я думаю, всем ясно, что даже идеальный алгоритм поддержки процессоров в конечном итоге должен быть изменен, потому что процессоры в конечном итоге также меняются  
...
> _**learninandlurkin:**_ Если широко распространенные процессоры нового поколения работают лучше, чем более старые, то более старые по логике вещей становятся новой формой ASIC, верно?  
...
> _**learninandlurkin:**_ да, заглядывать далеко вперед сейчас бессмысленно  
...
> _**moneromooo:**_ Я предпочел бы разозлить сервисы, чем забавляться риском атаки 51%  
> _**ferretinjapan:**_ ^  
...
> _**fluffypony:**_ Я также не думаю, что протокол Monero должен костенеть, потому что мы должны постоянно улучшать конфиденциальность  
...
> _**learninandlurkin:**_ Будущее, когда мы проводим ежегодные обновления протокола и включаем в них периодическое обновление PoW, лучше отражает инновации на данном рынке  
...
> _**learninandlurkin:**_ на определенную дату  
...
> _**needmoney90:**_ полагаю, пауза затянется на 4-6 месяцев  
...
> _**learninandlurkin:**_ MONERO 2039. ЖУРНАЛ ОБНОВЛЕНИЯ СЕТИ: 1) Переход на QuantumX, чтобы уменьшить преимущества Quantum ASIC и замедлить вторжение Terminator.  
> _**fluffypony:**_ LOL  
...
> _**learninandlurkin:**_ Это, скорее, зависит от характера неудачи и возможных сроков для исправления ошибки. Еще стоит учитывать процесс аудита...  
...
> _**fluffypony:**_ lol  
> _**learninandlurkin:**_ Не совсем надстройка, если только что-то вроде «более случайная случайность в RandomX»  
> _**ArticMine:**_ fluffypony: Несколько месяцев — это все, что нужно знать производителям  
> _**dEBRUYNE:**_ Я думаю, что многие люди недооценивают риски, связанные с надстройкой  
> _**needmoney90:**_ ^^^^^^^^^  
...
> _**fluffypony:**_ гонка вооружений состоит в том, чтобы быть первым на рынке  
...
> _**vp11:**_ Да, улучшения - это надстройки, но и не совсем. Как вы думаете, Билл Гейтс был прав, когда сказал, что 640k достаточно для всех? Эволюция...  
> _**sgp\_:**_ dEBRUYNE: по иронии, я полагаю, мы знаем, что это лучше, чем ASICs, учитывая недавние события  
> _**fluffypony:**_ если мы обозначим сроки, избавимся от мнимой гонки производителей  
...
> _**dEBRUYNE:**_ _**fluffypony:**_ гонка вооружений состоит в том, чтобы быть первым на рынке <= я не думаю, что это является первоочередной проблемой  
...
> _**sgp\_:**_ dEBRUYNE: Я думаю, что важно проводить различие между запланированными изменениями направленными на устранение (текущие) и улучшениямим Random X. Они имеют разные причины и последствия  
...
> _**learninandlurkin:**_ Я вообще боюсь обязательств, поэтому я голосую против сроков и тем более даты  
> _**el00ruobuob\_[m]:**_ vp11, +1  
> _**dEBRUYNE:**_ sgp_: «улучшения» - это хитрости и вытекающие отсюда риски. Кроме того, кто может объективно определить, что это действительно улучшения?  
...
> _**dEBRUYNE:**_ конечно, там слишком много наслоений  
...
> _**dEBRUYNE:**_ oneiric_: Это в любом случае риск, но небольшой  
...
> _**learninandlurkin:**_ Любое объявление о дате переключения полагается на (ASIC SHA-3, произведенные для свободной продажи) > > (ASIC SHA-3, произведенные с целью извлечения выгоды в текущем форке)  
> _**fluffypony:**_ vp11: аргумент заключается в том, что RandomX самое необходимое для ASIC  
> _**dEBRUYNE:**_ нельзя сравнить улучшения в разрезе протокола с улучшениями в ключе алгоритма PoW  
> _**learninandlurkin:**_ таким образом, это очень сильно может повлиять на состояние рынка  
> _**fluffypony:**_ извините, я хотел сказать - для ASIC противодействия  
> _**vp11:**_ мы поняли :)  
> _**ArticMine:**_ fluffypony, RandomX - далеко не панацея против всех ASIC  
...
> _**fluffypony:**_ sech1: Да, я могу. Он не достигнет своей заявленной цели в долгосрочной перспективе - нестандартная материнская плата с кучей CPU или GPU неотличима от дорогого ASIC  
...
> _**sech1:**_ fluffypony, тогда мы имеем разные определения неудачи  
...
> _**sech1:**_ нестандартную материнскую плату с преимуществом 1,5x вряд ли можно назвать ASIC -> нет смысла хранить такую поделку в тайне, выгоднее будет продавать их  
...
> _**needmoney90:**_ ?  
> _**sech1:**_ fluffypony, эта модель работает не только с эффективностью выше чем 1.5-3x  
...
> _**needmoney90:**_ Articmine, разве POS-обновление / бомба сложности отложили инвестиции в asic?  
...
> _**learninandlurkin:**_ да, повсеместность - мощная сила, способная остановить атаку на 51%  
...
> _**learninandlurkin:**_ Порог входа для создания ботнета потенциально намного ниже, чем для создания фермы ASIC  
...
> _**dr-mike:**_ Преимущество GPU более чем 10x  
> _**ArticMine:**_ Это на GPU через год после ASIC  
...
> _**learninandlurkin:**_ После прочтения этого обсуждения я думаю, долгосрочные планы в значительной степени бессмысленны, пока у нас не будет проведено несколько аудитов / обзоров / тестирований RandomX  
...
> _**dEBRUYNE:**_ Я скептически отношусь к тому, что asic преимущество для ETH asics останется на уровне 2.3x, хотя  
...
> _**learninandlurkin:**_ (или если ETH просто рухнет)  
...
> _**learninandlurkin:**_ вам нужна машина времени для синхронизации блокчейна ETH  
> _**oneiric\_:**_ lol  
...
> _**learninandlurkin:**_ для большей ясности ситуации - мы обсуждаем текущий хэш ETH или ProgPow?  
...
> _**learninandlurkin:**_ мы можем украсть их идею в качестве резервного плана, когда eth уйдёт на PoS  
...
> _**oneiric\_:**_ виноват, исправлюсь  
...
> _**hyc:**_ rbrunner, да  
> _**learninandlurkin:**_ приятно знать, что есть другие PoW, которые могут быть «украдены», если RandomX дает сбой и потребуется затычка  
> _**dEBRUYNE:**_ Если randomx терпит неудачу, разве progpow не последует за ним?  
> _**moneromooo:**_ Progpow нацелен на архитектуру, которая уже оптимизирована для паралельной работы  
> _**sgp\_:**_ learninandlurkin, я думаю, что это хороший повод взглянуть на это  
> _**rbrunner:**_ Нет дефицита в затычках. Берите любой другой, по существу  
> _**moneromooo:**_ (хотя я не знаю, что он делает)  
> _**dEBRUYNE:**_ learninandlurkin: не уверен, зачем нам нужна затычка в таком случае, хотя  
...
> _**crCr62U0:**_ 10e+6$?  
> _**tevador:**_ В 10 раз эффективнее? Я не думаю, что даже всего годового бюджета AMD на исследования и разработки будет достаточно  
...
> _**learninandlurkin:**_ У Linzhi уже все готово, по его заявлениям  
...
> _**learninandlurkin:**_ Мы можем заручиться поддержкой Outreach для распространения ссылок на документацию RandomX?  
> _**tevador:**_ интеграция daemon потребует немного больше времени, чем CNv4  
...
> _**learninandlurkin:**_ еще предлагаю переименовать «Общий фонд CCS» на «Остро необходимый фонд для ревизии RandomX»  
> _**oneiric\_:**_ ^  
...
> _**hyc:**_ насколько я знаю ETH только недавно решил провести аудит для progpow  
> _**moneromooo:**_ Разве там не добавили циклы около недели назад? Это похоже на большое изменение, чтобы быть готовым  
...
> _**tevador:**_ сейчас это C++  
> _**learninandlurkin:**_ или нас ждут 4-5 месяцев поисков рецензентов и провал по сбору средств для оплаты их работы :( как вариант  
...
> _**learninandlurkin:**_ Аудиторы ProgPow - это Nvidia?  
> _**oneiric\_:**_ спасибо, с нетерпением жду встречи с тем, кого они выберут, и чтения аудита, когда он будет завершен  
> _**hyc:**_ tevador: наверное нет, это была моя личная инициатива  
> _**dEBRUYNE:**_ _**moneromooo:**_ Разве там не добавили циклы около недели назад? Это похоже на большое изменение, чтобы быть готовым <= tevador, есть какие-нибудь комментарии по этому поводу?  
> _**moneromooo:**_ Я не имею ввиду, что это должно стоять на месте :)  
> _**tevador:**_ не циклы, была изменена одна инструкция возврата, таким образом что циклы невозможны  
> _**moneromooo:**_ OK, ветвления  
...
> _**rbrunner:**_ это относится к «хорошо бы иметь данный механизм», а не «черт, как мы могли забыть это!»  
...
> _**tevador:**_ главная цель - использовать этапы фиксации / отката в работе CPU  
> _**moneromooo:**_ Насколько я понимаю, программы не будут известны заранее, или то, что sech1 делал с CNR, верно?  
> _**ferretinjapan:**_ dr-mike, кто-то должен это делать :)  
> _**tevador:**_ без этого ASIC мог бы уже встать на конвейер  
...
> _**learninandlurkin:**_ Я голосую за последний комментарий hyc  
...
> _**learninandlurkin:**_ я присоединяюсь к -> _**moneromooo:**_ RandomX, а затем (1), если у нас есть другой претендент на эту должность, переключаемся на него, или (2), если, по-видимому, ASIC берут всё в свои руки и занимают 50% сети, затем надстройка и (3) SHA-3.  
...
> _**sgp\_:**_ Вдобавок к этому существует примерно 3 месяца, между определением понятия неудачи и переходом к SHA3, если это желаемый вариант. В целом Monero либо может использовать затычку на это время либо подождать.  
...
> _**vtnerd\_\_:**_ Randomx в октябре кажется довольно агрессивным решением, если интеграция daemon настолько сложна. К сожалению, на данный момент оптимизирована только версия для x86  
> _**sgp\_:**_ ASICs на 20% показывают превосходство и начинают укреплять позиции? Давайте посмотрим, что из этого может выйти  
> _**dEBRUYNE:**_ tevador: Сможете ли вы интегрировать randomx с daemon?  
> _**learninandlurkin:**_ Природа теоретических сбоев заключается в большом ограничении планирования вне аудита. RandomX действительно очень хорошо должен себя проявить  
...
> _**jwinterm:**_ не на много, они используют варианты blake, которые являются другой реализацией sha3  
> _**sgp\_:**_ до намерения перейти на SHA3 у Monero не могло быть ресурсов, которые помогают производителям идти навстречу покупателю и снижать порог входа в майнинг  
...
> _**moneromooo:**_ ferretinjapan: за «простоту вступления в клуб производителей ASIC»? Думаю, их можно не перечислять :)  
...
> _**nioc:**_ sgp +1  
> _**ferretinjapan:**_ Но тем не менее, кто знает, возможно, QC сможет поставить «заплатку» в SHA 3, насколько я знаю, и через 5-10 лет, и мы снова здесь.  
> _**moneromooo:**_ ph4r05: так что, {} inits to NULL, для надежности?  
...
> _**sech1:**_ да, это не должно быть замкнуто на SHA3  
...
> _**dEBRUYNE:**_ для протокола, хотели бы участники, чтобы я открыл новый выпуск на Github, где мы можем продолжить обсуждение деталей?  
...
> _**ferretinjapan:**_ да, вероятно, будет целый спектр различных «провалов», которые вы бы хотели определить заранее ;)  
> _**sgp\_:**_ ferretinjapan: это точно  
> _**sgp\_:**_ fwiw, в нижней части расписания встречи я добавил пункт «экстренная настройка сети, для возможности деактивации ASIC». Я думаю, что мы можем обсудить это  
> _**sgp\_:**_ добавлю еще немного предыстории:  
> _**dEBRUYNE:**_ Давайте завершим уже эту встречу :p  
> _**sgp\_:**_ 1) Monero реализовал RandomX и 2) Monero не имеет хорошей способности для быстрого перехода на дружественный к ASIC алгоритм  
...
_Источник: [Monero DevMeeting 2019-03-24_](https://repo.getmonero.org/monero-project/monero-site/blob/b87354501b6343f9146f331805ddadc45696f728/_posts/2019-03-24-logs-for-the-dev-meeting-held-on-2019-03-24.md)  
